...
var isServerRendering = function () {
    if (_isServer === undefined) {
        /* istanbul ignore if */
        if (!inBrowser$1 && typeof global$1 !== 'undefined') {
...
function add(name, handler, capture, passive) {
    ...
    target$2.addEventListener(name, handler, supportsPassive ? { capture: capture, passive: passive } : capture);
}
function remove(name, handler, capture, _target) {
    (_target || target$2).removeEventListener(name, 
    //@ts-expect-error
...
// @ts-ignore
VueRouter$1.prototype.isReady = function () {
...
function createRouter(options) {
    Vue2.use(VueRouter$1);
    return new VueRouter$1(options);
}

export { Vue$1 as V, Vue2 as a, mapActions as b, createStore as c, mapGetters as d, createRouter as e, global$1 as g, mapState as m, vue_runtime_esm as v };
//# sourceMappingURL=vue.0c4d750d.js.map
